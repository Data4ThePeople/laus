...
Colorado is fourth on the list, and it is the opposite story from Michigan. There the big metro counties are holding while the rest slides. In Colorado every one of the ten largest counties is shrinking, Denver included, and the flags have not caught up yet.
