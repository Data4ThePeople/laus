# Hero image prompts: Is America betting the house on its billionaires?

Target: 1680x1080 landscape. Generate wide, at 3:2 or 16:9 and at least 1680
pixels on the long side; the crop is done with `~/.claude/d4tp-process/hero fit`.

House palette to name in the prompt when the generator respects color:
paper `#F7F5EF`, teal `#085041`, coral `#712B13`.

Rules for every variant: no identifiable real people, no real company logos or
brand marks, no readable text or numbers in the image, no flags, no political
