...
There's another billionaire whose company [flew about half of everything that reached orbit last year](https://www.space.com/space-exploration/private-spaceflight/spacex-shatters-its-rocket-launch-record-yet-again-167-orbital-flights-in-2025), and roughly 85% of what left the United States. NASA used to do this sort of frontier work. Now, we have outsourced control to a billionaire. In his free time, he also led a program to get rid of a bunch of government employees (in the name of efficiency) which had the unintended (?) consequence of [leaving VA hospitals short of custodial staff](https://www.vaoig.gov/reports/national-healthcare-review/oig-determination-veterans-health-administrations-severe-1).
